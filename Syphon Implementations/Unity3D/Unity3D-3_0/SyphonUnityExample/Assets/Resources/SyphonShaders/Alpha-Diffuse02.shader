Shader "Syphon/Transparent/Diffuse2" {
Properties {
...
SubShader {
	...
	AlphaTest Greater 0 ZWrite Off Cull Off
...
"!!GLES"
	...
	Pass {
		...
		AlphaTest Greater 0 ZWrite Off Cull Off Blend SrcAlpha OneMinusSrcAlpha Fog { Color (0,0,0,0) }
		Blend SrcAlpha OneMinusSrcAlpha
Program "vp" {
// Vertex combos: 5
//   opengl - ALU: 10 to 18
